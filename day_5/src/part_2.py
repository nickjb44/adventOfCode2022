...
def shift_stack_containers(stacks, n_moves, popped_stack_index, pushed_stack_index):
    """
    ...
    for _ in range(n_moves):
        tmp.append(stacks[popped_stack_index].pop())
    for _ in range(n_moves):
        stacks[pushed_stack_index].append(tmp.pop())
    return
